...
CREATE TABLE IF NOT EXISTS IDN_JWT_PRIVATE_KEY (JWT_ID VARCHAR(255), EXP_PERIOD BIGINT DEFAULT 0,
TIME_CREATED TIMESTAMP DEFAULT 0, PRIMARY KEY (JWT_ID));

INSERT INTO IDN_JWT_PRIVATE_KEY (JWT_ID,EXP_PERIOD,TIME_CREATED)VALUES ('2000', 10000, CURRENT_TIMESTAMP);