...
package org.wso2.carbon.identity.oauth2.token.handler.clientauth.extendedbasic.internal;
...
import org.wso2.carbon.identity.oauth2.token.handler.clientauth.extendedbasic.MutualTLSWithIdSecretAuthenticator;

/**
 * TLS Mutual Auth with basic osgi Component.
 */
@Component(
        name = "org.wso2.carbon.identity.oauth2.token.handler.clientauth.extendedbasic",
        immediate = true
)
